...
with open('e:/finalrox/admin.html', 'r', encoding='utf-8') as f:
    html = f.read()
...
if style_match:
    ...
    with open('e:/finalrox/admin/style.css', 'w', encoding='utf-8') as f:
...
with open('e:/finalrox/admin/script.js', 'w', encoding='utf-8') as f:
...
with open('e:/finalrox/admin/index.html', 'w', encoding='utf-8') as f:
    f.write(html.strip())
