...
function closeOv(){document.getElementById('product-overlay').classList.remove('on');document.body.style.overflow='';}
...
function clearCart(){
  if(confirm('Are you sure you want to clear your cart?')){
    cart=[];saveCart();renderCart();updateBadge();showToast('Cart cleared','✕');
  }
}
